...
public class PcRetryServiceImplTest {
    ...
    void getPcRetryFoundTest() {
        ...
        Mockito.when(pcRetryUtils.checkHasOtherAttemptAndMapPcRetryResponse("requestId_.PCRETRY_0", pnDeliveryRequest))
    ...
    void getPcRetryNotFoundTest() {
        ...
        Mockito.when(pcRetryUtils.checkHasOtherAttemptAndMapPcRetryResponse("requestId", pnDeliveryRequest))
                .thenReturn(Mono.just(response));
