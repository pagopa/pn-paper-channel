...
class RECRN005CMessageHandlerTest {
    ...
    private static final String REQUEST_ID = "1234LL-GGGG-SSSS";
    ...
    void should_pushPNRN012_when_RECRN005AGreaterOrEqualsRECRN010By30Days (){
        ...
        assertEquals(STATUS_RECRN005C, deliveryRequest.getFeedbackOriginalStatusCode());
        assertEquals(STATUS_PNRN012, deliveryRequest.getFeedbackStatusCode());
    ...
    void should_savePnEventError_when_RECRN005ALessRECRN010By60Days() {
        ...
        var RECRN005AInstant = Instant.parse("2025-04-08T19:02:10Z");
