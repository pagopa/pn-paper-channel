...
echo "### CREATE QUEUES ###"
queues="local-delivery-push-safestorage-inputs local-paper_channel_requests local-delivery-push-inputs local-ext-channels-inputs local-ext-channels-outputs pn-f24_to_paperchannel local-paper-normalize-address"
