...
echo "### CREATE QUEUES ###"
queues="local-delivery-push-safestorage-inputs local-paper_channel_requests local-ext-channels-inputs local-ext-channels-outputs pn-f24_to_paperchannel local-paper-normalize-address local-delayer_to_paperchannel local-ocr-inputs local-paperchannel_to_delayer"
