...
bash <(curl -s https://raw.githubusercontent.com/pagopa/pn-paper-channel/98e5f49cce047fa486fba2e2c8843a6ae5553486/src/test/resources/testcontainers/init.sh)
