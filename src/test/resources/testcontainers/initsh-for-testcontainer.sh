...
bash <(curl -s https://raw.githubusercontent.com/pagopa/pn-paper-channel/d122771ade845a7e15bb227dca54b36c8e710d73/src/test/resources/testcontainers/init.sh)
