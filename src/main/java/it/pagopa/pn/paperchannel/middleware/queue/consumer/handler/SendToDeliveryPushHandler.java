...
@Slf4j
@SuperBuilder
public class SendToDeliveryPushHandler implements MessageHandler {
    ...
    private void pushSendEvent(PnDeliveryRequest pnDeliveryRequest, PaperProgressStatusEventDto paperRequest) {
        ...
        String clientId = ClientIdHelper.getClientId(pnDeliveryRequest.getRequestId(), MDC.get(Const.CONTEXT_KEY_CLIENT_ID));

        if (clientId.equals(CLIENT_ID_DELIVERY_PUSH)) {
