...
public enum ExceptionTypeEnum{
    ...
    CLIENT_ID_IS_REQUIRED("CLIENT_ID_IS_REQUIRED", "L'header X-Client-Id è obbligatorio"),
    ...
    GEOKEY_NOT_FOUND("GEOKEY_NOT_FOUND", "Non è stato trovata nessuna Geokey per la gara attiva"),
    ...
    COST_DRIVER_OR_FSU_NOT_FOUND("COST_DRIVER_OR_FSU_NOT_FOUND", "Il costo per il prodotto richiesto non è presente tra i recapitisti e nel FSU"),
    ...
    INVALID_PRODUCT_TYPE("INVALID_PRODUCT_TYPE", "Il tipo di prodotto non è corretto."),
